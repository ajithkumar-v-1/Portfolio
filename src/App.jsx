...
const PROJECTS = [
  ...
  },
  {
    ...
    year: "2025",
    problem:
      "B2B buyers couldn't request quotes online — all leads came through calls only.",
    solution:
  ...
  },
  {
    ...
    year: "2025",
    problem:
      "Established offline business with no digital footprint — invisible to younger procurement managers.",
    solution:
    ...
    <div className="app">
      ...
      <nav className={`nav ${scrolled ? "nav--scrolled" : ""}`}>
        <div className="nav__inner">
          ...
          <button className="nav__hire" onClick={() => scrollTo("Contact")}>
            Hire Me
          </button>
            ...
            <div className="about__id-card">
              ...
              <div className="about__badges">
                <div className="about__badge-item">
                  ...
                  <div>
                    <span className="about__badge-title">MERN Stack</span>
                    <span className="about__badge-org">GUVI</span>
                  </div>
                </div>
                <div className="about__badge-item">
                  <span className="about__badge-icon">🌐</span>
                  <div>
                    <span className="about__badge-title">Web Development</span>
                    <span className="about__badge-org">Internship Studio</span>
                  </div>
                </div>
                <div className="about__badge-item">
                  <span className="about__badge-icon">🏦</span>
                  <div>
                    <span className="about__badge-title">Virtual Experience</span>
                    <span className="about__badge-org">Goldman Sachs · Forage</span>
                  </div>
                </div>
                <div className="about__badge-item about__badge-item--accent">
                  <span className="about__badge-icon">🏆</span>
                  <div>
                    <span className="about__badge-title">Hackathon</span>
                    <span className="about__badge-org">IIT Madras</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container contact__grid">
          ...
          <div className="contact__right">
            <form ref={formRef} onSubmit={handleSubmit} className="form">
              ...
              {formState === "sent" && (
                <p className="form__success">Thanks! I'll reply within 24 hours.</p>
              )}
              {formState === "error" && (
                <p className="form__error">Something went wrong. Email me directly.</p>
              )}
            </form>
          </div>
        </div>
